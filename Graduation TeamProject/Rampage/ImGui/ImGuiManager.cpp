...
void CImGuiManager::SetUI()
{
	...
	auto AllAttackReset = []() {
		Atk1_Player::GetInst()->ResetComponents();
		Atk2_Player::GetInst()->ResetComponents();
		Atk3_Player::GetInst()->ResetComponents();
	};
	...
	if (show_survey_menu)
	{
		...
		if (ImGui::Button(U8STR("2-1")))
		{
			...
			Atk2_Player::GetInst()->GetImpactComponent()->Reset(true);
			Atk3_Player::GetInst()->GetImpactComponent()->Reset(true);
		}
