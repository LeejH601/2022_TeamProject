...
void CGameFramework::InitSound()
{
	...
	CSoundManager::GetInst()->RegisterSound("Sound/Background/Ambient 8.wav", true, SOUND_CATEGORY::SOUND_BACKGROUND);
	...
	CSoundManager::GetInst()->RegisterSound("Sound/effect/Swoosh Explosion by Electroviolence Id-234555 1.wav", false, SOUND_CATEGORY::SOUND_SHOCK);
...
void CGameFramework::ChangeSwapChainState()
{
	...
	m_pdxgiSwapChain->SetFullscreenState(!bCurrentFullScreenState, NULL);
