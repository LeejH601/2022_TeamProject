...
void CMainTMPScene::BuildObjects(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	...
	int nOffsetUI = m_pTextureManager->GetTextureOffset(TextureType::UITexture) - 1;
	...
	pUIObject->SetTextureIndex(0 + nOffsetUI);
	...
	pUIObject->SetTextureIndex(1 + nOffsetUI);
	m_pUIObject.push_back(std::move(pUIObject));
	...
	pUIObject->SetTextureIndex(2 + nOffsetUI);
	m_pUIObject.push_back(std::move(pUIObject));
	...
	pUIObject->SetTextureIndex(6 + nOffsetUI);
	m_pUIObject.push_back(std::move(pUIObject));
	...
	pUIObject->SetTextureIndex(17 + nOffsetUI);
	m_pUIObject.push_back(std::move(pUIObject));
...
void CMainTMPScene::LoadTextureObject(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	...
	m_pTextureManager->LoadTexture(TextureType::UITexture, pd3dDevice, pd3dCommandList, L"Image/UiImages/Combo2.dds", 0, 0);
