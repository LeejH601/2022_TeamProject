...
public:
	...
	CGameObject* AddBoundingObject(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, CGameObject* pParent, XMFLOAT3 xmf3AABBCenter, XMFLOAT3 xmf3AABBExtents);
