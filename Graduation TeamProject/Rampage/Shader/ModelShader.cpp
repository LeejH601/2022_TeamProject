...
D3D12_RASTERIZER_DESC CModelShader::CreateRasterizerState(int nPipelineState)
{
...
D3D12_SHADER_BYTECODE CModelShader::CreateVertexShader(ID3DBlob** ppd3dShaderBlob, int nPipelineState)
{
	return(CShader::ReadCompiledShaderFile(L"PlayerVertexShader.cso", ppd3dShaderBlob));
}
D3D12_SHADER_BYTECODE CModelShader::CreatePixelShader(ID3DBlob** ppd3dShaderBlob, int nPipelineState)
{
	return(CShader::ReadCompiledShaderFile(L"PlayerPixelShader.cso", ppd3dShaderBlob));
}
D3D12_INPUT_LAYOUT_DESC CModelShader::CreateInputLayout(int nPipelineState)
{
