#include "UIObjectShader.h"
#include "../Object/Texture.h"
void CUIObjectShader::CreateShader(ID3D12Device* pd3dDevice, ID3D12RootSignature* pd3dGraphicsRootSignature, UINT nRenderTargets, DXGI_FORMAT* pdxgiRtvFormats, DXGI_FORMAT dxgiDsvFormat, int nPipelineState)
{
	m_nPipelineStates = 1;
...
D3D12_DEPTH_STENCIL_DESC CUIObjectShader::CreateDepthStencilState(int nPipelineState)
{
...
D3D12_BLEND_DESC CUIObjectShader::CreateBlendState(int nPipelineState)
{
...
D3D12_RASTERIZER_DESC CUIObjectShader::CreateRasterizerState(int nPipelineState)
{
...
void CUIObjectShader::Render(ID3D12GraphicsCommandList* pd3dCommandList, int nPipelineState)
{
...
D3D12_SHADER_BYTECODE CUIObjectShader::CreateVertexShader(ID3DBlob** ppd3dShaderBlob, int nPipelineState)
{
	return(CShader::ReadCompiledShaderFile(L"UIObjectVertexShader.cso", ppd3dShaderBlob));
}
D3D12_SHADER_BYTECODE CUIObjectShader::CreatePixelShader(ID3DBlob** ppd3dShaderBlob, int nPipelineState)
{
	return(CShader::ReadCompiledShaderFile(L"UIObjectPixelShader.cso", ppd3dShaderBlob));
}
//D3D12_SHADER_BYTECODE CUIObjectShader::CreateGeometryShader(ID3DBlob** ppd3dShaderBlob, int nPipelineState)
//{
//	return(CShader::ReadCompiledShaderFile(L"BillboardObjectGSShader.cso", ppd3dShaderBlob));
//}
D3D12_INPUT_LAYOUT_DESC CUIObjectShader::CreateInputLayout(int nPipelineState)
{
